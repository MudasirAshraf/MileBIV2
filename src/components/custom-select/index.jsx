  ...
  return (
    <div className="custom-select">
      <div className="selected-option" onClick={() => setIsOpen(!isOpen)}>
        {selectedOption}
        {selectedOption !== "Select Workspaces" && (
      ...
      {isOpen && (
        <div className="options">
          ...
          <div className="option" onClick={() => handleOptionClick("Mile BI")}>
            Mile BI{" "}
            {selectedOption === "Mile BI" && <img src={Tick} alt="Tick" />}
          </div>
          <div
            className="option"
            onClick={() => handleOptionClick("Workspace 2")}
          >
            Workspace 2{" "}
            {selectedOption === "Workspace 2" && <img src={Tick} alt="Tick" />}
          </div>
          <div
            className="option"
            onClick={() => handleOptionClick("Workspace 3")}
          >
            Workspace 3{" "}
            {selectedOption === "Workspace 3" && <img src={Tick} alt="Tick" />}
          </div>
