...
const WhereConditions = ({
  ...
  return (
    <div className="where-consitions-container">
      <FieldArray name="whereConditions">
        {({ push, remove }) => (
          <>
            <p className="conditions-para-header">Conditions</p>
            {values?.whereConditions?.map((condition, condIndex) => {
              ...
              const options = uniqueValues[key]
                ? uniqueValues[key].map((value) => ({ value, label: value }))
                : [];

              const isMultiSelect = ["IN", "NOT IN"].includes(
                condition?.operator
              );
              ...
              return (
                <div className="where-condition-box" key={condIndex}>
                  {/* Column Selection */}
                  <div>
                    <label
                      htmlFor={`whereConditions[${condIndex}].column`}
                    ...
                    <Select
                      ...
                      value={categoriesOptions?.find((option) => {
                        const parsedValue = option?.value
                      ...
                      onChange={(selectedOption) => {
                        const parsedValue = selectedOption?.value
                      ...
                      className="select-container-reactbox"
                  ...
                  <div>
                    <label
                      htmlFor={`whereConditions[${condIndex}].operator`}
                      className="form-label-input"
                    >
                      Operator:
                    </label>
                  ...
                  <div>
                    <label
                      htmlFor={`whereConditions[${condIndex}].value`}
                      className="form-label-input"
                    >
                      Value:
                    </label>
                    ...
                    <div className="form-check" style={{ marginTop: "10px" }}>
                      ...
                      />
                      <label
                        htmlFor={`manual-input-${condIndex}`}
            ...
            <button
              ...
              onClick={() =>
                push({ operator: "", value: "", column: "", datasetName: "" })
              }
            >
