...
import GV from "../../assets/svg/gV.svg";
                ...
                <table>
                  <thead>
                    <tr>
                      <th>Date</th>
                      <th>Title</th>
                      <th className="average-sale-container-dashboard-IV">
                        Average Sale
        ...
        <div className="db-IV">
          <div className="input-group-sign-in-row-I-dm-VV">
            <input
              ...
              name="sql-query"
              className="input-details-sign-in-row-I-dm-VV"
            />
          </div>
        </div>
        {/* adding another div */}
